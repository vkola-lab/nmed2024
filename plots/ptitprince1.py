...
def RainCloud(x = None, y = None, hue = None, data = None,
    ...
    kwcloud = dict()
    kwbox   = dict(saturation = 1, whiskerprops = {'linewidth': linewidth, "zorder": 10}, flierprops = dict(markersize=0.5))
    ...
    bp = sns.boxplot   (x = x, y = y, hue = hue, data = data, orient = orient, width = width_box,
                         order = order, hue_order = hue_order,
                         color = boxcolor, showcaps = True, 
                         palette = palette, dodge = dodge, linewidth=linewidth, ax =ax, **kwbox)
